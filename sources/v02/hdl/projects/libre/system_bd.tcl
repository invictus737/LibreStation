...
# Add timestamp IP repo from Wahlm/pgreenland hdl-quantulum
...
# ddr750: original 625MHz timing
# ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CL {7}
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CL {8}
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_T_RP {8}
...
source $ad_hdl_dir/projects/libre/libre_timestamp_bd_patch.tcl
